    ...
    public class EmployeeRep :IEmployeeRep
    {
        ...
        private EmployeeVM GetEmployeeByID(int id)
        {
            return db.Employee.Where(a => a.Id == id)
                                    .Select(a => new EmployeeVM { Id = a.Id, Name = a.Name, Salary = a.Salary, Address = a.Address, HireDate = a.HireDate, IsActive = a.IsActive, Email = a.Email, Notes = a.Notes, DepartmentId = a.Department.DepartmentName, PhotoName = a.PhotoName, CvName = a.CvName })
                                    .FirstOrDefault();
        }
